...
$text1 = $userManager->readTextField(1);
$text2 = $userManager->readTextField(2);
$text3 = $userManager->readTextField(3);
$text4 = $userManager->readTextField(4);
$text5 = $userManager->readTextField(5);
$text6 = $userManager->readTextField(6);
$text7 = $userManager->readTextField(7);
$text8 = $userManager->readTextField(8);
$text9 = $userManager->readTextField(9);
$text10 = $userManager->readTextField(10);
$text11 = $userManager->readTextField(11);
$text12 = $userManager->readTextField(12);

if ($_SERVER["REQUEST_METHOD"] == "POST") {
  $userManager->writeTextField(1, $_POST['textVal1']);
  $userManager->writeTextField(2, $_POST['textVal2']);
  $userManager->writeTextField(3, $_POST['textVal3']);
  $userManager->writeTextField(4, $_POST['textVal4']);
  $userManager->writeTextField(5, $_POST['textVal5']);
  $userManager->writeTextField(6, $_POST['textVal6']);
  $userManager->writeTextField(7, $_POST['textVal7']);
  $userManager->writeTextField(8, $_POST['textVal8']);
  $userManager->writeTextField(9, $_POST['textVal9']);
  $userManager->writeTextField(10, $_POST['textVal10']);
  $userManager->writeTextField(11, $_POST['textVal11']);
  $userManager->writeTextField(12, $_POST['textVal12']);
  header("Refresh:0");
}
?>
...
<!-- Navbar -->
<div class="w3-top">
  <div id="navDemo" class="w3-bar w3-blue w3-card w3-left-align w3-large w3-medium w3-small">
    <a class="w3-bar-item w3-button w3-hide-medium w3-hide-large w3-hide-small w3-right w3-padding-large w3-hover-white w3-large w3-blue" href="javascript:void(0);" onclick="myFunction()" title="Toggle Navigation Menu"><i class="fa fa-bars"></i></a>
...
<header class="w3-container w3-blue w3-center" style="padding:128px 16px">
  ...
  <h2 class="w3-xxlarge">TEAM BLUE</h2>
  <br>
    <?php if($logged_in){ ?>
        <p class="w3-large w3-pale-blue">You are logged in. You can edit this scrum board. Save canges by clicking the submit button on the bottom.</p>
    <?php }else{ ?>
        <p class="w3-large w3-pale-blue">You are not logged in. You cannot edit this scrum board.</p>
    <?php } ?>
</header>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <div class="w3-third w3-center">
      <i class="fa fa-bolt w3-padding-64 w3-text-blue"></i>
    </div>
  </div>
</div>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-third w3-center">
      <i class="fa fa-bicycle w3-padding-64 w3-text-blue w3-margin-right"></i>
    </div>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-third w3-center">
      <i class="fa fa-adjust w3-padding-64 w3-text-blue w3-margin-right"></i>
    </div>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <div class="w3-third w3-center">
      <i class="fa fa-car w3-padding-64 w3-text-blue"></i>
    </div>
  </div>
</div>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-third w3-center">
      <i class="fa fa-diamond w3-padding-64 w3-text-blue w3-margin-right"></i>
    </div>
