...
$text1 = $userManager->readTextField(41);
$text2 = $userManager->readTextField(42);
$text3 = $userManager->readTextField(43);
$text4 = $userManager->readTextField(44);
$text5 = $userManager->readTextField(45);
$text6 = $userManager->readTextField(46);
$text7 = $userManager->readTextField(47);
$text8 = $userManager->readTextField(48);
$text9 = $userManager->readTextField(49);
$text10 = $userManager->readTextField(50);
$text11 = $userManager->readTextField(51);
$text12 = $userManager->readTextField(52);

if ($_SERVER["REQUEST_METHOD"] == "POST") {
  $userManager->writeTextField(41, $_POST['textVal1']);
  $userManager->writeTextField(42, $_POST['textVal2']);
  $userManager->writeTextField(43, $_POST['textVal3']);
  $userManager->writeTextField(44, $_POST['textVal4']);
  $userManager->writeTextField(45, $_POST['textVal5']);
  $userManager->writeTextField(46, $_POST['textVal6']);
  $userManager->writeTextField(47, $_POST['textVal7']);
  $userManager->writeTextField(48, $_POST['textVal8']);
  $userManager->writeTextField(49, $_POST['textVal9']);
  $userManager->writeTextField(50, $_POST['textVal10']);
  $userManager->writeTextField(51, $_POST['textVal11']);
  $userManager->writeTextField(52, $_POST['textVal12']);
  header("Refresh:0");
}
?>
...
<!-- Navbar -->
<div class="w3-top">
  <div id="navDemo" class="w3-bar w3-yellow w3-card w3-left-align w3-large w3-medium w3-small">
    <a class="w3-bar-item w3-button w3-hide-medium w3-hide-large w3-hide-small w3-right w3-padding-large w3-hover-white w3-large w3-yellow" href="javascript:void(0);" onclick="myFunction()" title="Toggle Navigation Menu"><i class="fa fa-bars"></i></a>
...
<h2 class="w3-xxlarge">TEAM YELLOW</h2>
  <br>
    <?php if($logged_in){ ?>
        <p class="w3-large w3-pale-yellow">You are logged in. You can edit this scrum board. Save canges by clicking the submit button on the bottom.</p>
    <?php }else{ ?>
        <p class="w3-large w3-pale-yellow">You are not logged in. You cannot edit this scrum board.</p>
    <?php } ?>
</header>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <div class="w3-third w3-center">
      <i class="fa fa-bolt w3-padding-64 w3-text-yellow"></i>
    </div>
  </div>
</div>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-third w3-center">
      <i class="fa fa-bicycle w3-padding-64 w3-text-yellow w3-margin-right"></i>
    </div>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <div class="w3-third w3-center">
      <i class="fa fa-book w3-padding-64 w3-text-yellow"></i>
    </div>
  </div>
</div>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-third w3-center">
      <i class="fa fa-adjust w3-padding-64 w3-text-yellow w3-margin-right"></i>
    </div>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <div class="w3-third w3-center">
      <i class="fa fa-car w3-padding-64 w3-text-yellow"></i>
    </div>
  </div>
</div>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-third w3-center">
      <i class="fa fa-diamond w3-padding-64 w3-text-yellow w3-margin-right"></i>
    </div>
